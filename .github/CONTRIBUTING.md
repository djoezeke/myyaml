...
[by submitting a pull request](https://github.com/djoezeke/myyaml/edit/main/.github/CONTRIBUTING.md).
...
Please [create an issue](https://github.com/djoezeke/myyaml/issues/new/choose), assuming one does not already exist, and
...
[bug report](https://github.com/djoezeke/myyaml/blob/main/.github/ISSUE_TEMPLATE/bug.yaml) if possible.

### Reporting a security vulnerability

You can report a security vulnerability according to our
[security policy](https://github.com/djoezeke/myyaml/security/policy).

### Discussing a new feature

For questions, feature or support requests, please
[open a discussion](https://github.com/djoezeke/myyaml/discussions/new). If you find a proposed answer satisfactory,
...
Create a [pull request](https://github.com/djoezeke/myyaml/pulls?q=sort%3Aupdated-desc+is%3Apr+is%3Aopen) against the
...
- The library’s [README file](https://github.com/djoezeke/myyaml/blob/main/README.md) is an excellent starting point to
  understand its functionality.
- The [documentation page](https://djoezeke.github.io/myyaml) is the reference documentation of the library.
